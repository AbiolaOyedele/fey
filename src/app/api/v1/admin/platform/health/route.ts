...
import { getHealth } from '@/services/platform.service'
 ...
 *
 * Real health — probes the database rather than just returning 200.
 *
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json(await getHealth(db))
  } catch (err) {
    return handleError(err, 'PLATFORM_HEALTH_FAILED')
  }
}
