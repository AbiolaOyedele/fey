...
import { getStats } from '@/services/platform.service'
 ...
 *
 * Key metrics snapshot. Seven indexed head-only counts, run concurrently.
 *
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    return handleError(err, 'PLATFORM_STATS_FAILED')
  }
}
