...
export default function ClientCard({ client, onDelete, viewMode = 'grid' }: ClientCardProps) {
  ...
  if (viewMode === 'list') {
    return (
      ...
      >
        ...
        <span className="text-sm text-gray-500 w-24">{totalTasks} task{totalTasks !== 1 ? 's' : ''}</span>
